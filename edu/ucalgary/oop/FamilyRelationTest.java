...
public class FamilyRelationTest {
    ...
    @Before
    public void setUp() {
        personOne = new DisasterVictim("Kurt","2024-03-12"); 
        personTwo = new DisasterVictim("Jose","2024-03-12"); 
    ...
    public void testSetPersonOne() {
        DisasterVictim newPersonOne = new DisasterVictim("Michael","2024-03-13"); 
    ...
    public void testSetPersonTwo() {
        DisasterVictim newPersonTwo = new DisasterVictim("Colin","2024-03-13"); 
